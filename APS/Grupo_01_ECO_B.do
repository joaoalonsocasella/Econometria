...
histogram Median_House_Value , frequency normal
histogram Median_Income , frequency normal
histogram Median_Age , frequency normal
histogram Tot_Rooms , frequency normal
histogram Tot_Bedrooms , frequency normal
histogram Population , frequency normal
histogram Households , frequency normal
histogram Distance_to_coast , frequency normal
histogram Distance_to_LA , frequency normal
histogram Distance_to_SanDiego , frequency normal
histogram Distance_to_SanJose , frequency normal
histogram Distance_to_SanFrancisco , frequency normal
graph box Median_House_Value Median_Income Median_Age Tot_Rooms Tot_Bedrooms Population Households Distance_to_coast Distance_to_LA Distance_to_SanDiego Distance_to_SanJose Distance_to_SanFrancisco
ssc install winsor2
winsor2 Median_Income, replace cut(5,95) trim
winsor2 Median_Age, replace cut(5,95) trim
winsor2 Tot_Rooms, replace cut(5,95) trim
winsor2 Tot_Bedrooms, replace cut(5,95) trim
winsor2 Population, replace cut(5,95) trim
winsor2 Households, replace cut(5,95) trim
winsor2 Distance_to_coast, replace cut(5,95) trim 
winsor2 Distance_to_LA, replace cut(5,95) trim
winsor2 Distance_to_SanDiego, replace cut(5,95) trim
winsor2 Distance_to_SanJose, replace cut(5,95) trim
winsor2 Distance_to_SanFrancisco, replace cut(5,95) trim
